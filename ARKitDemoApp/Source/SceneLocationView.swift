...
public class SceneLocationView: ARSCNView, ARSCNViewDelegate {
    ...
    private var locationBoxNode: LocationNode?
    ...
    //create Box
    func createBox(locationNode: LocationNode) -> SCNNode  {
    ...
    public func addVectorLocationNodeWithConfirmedLocation(locationNodeFrom: LocationNode, locationNodeTo: LocationNode) {
        ...
        if self.locationNodeTo == nil {
            updatePositionOfLocationNodes(locationNodeFrom: locationNodeFrom, locationNodeTo: locationNodeTo, line: self.line)
            self.locationNodeTo = locationNodeTo
            self.locationNodeFrom = locationNodeFrom
        }
        else {
            updatePositionOfLocationNodes(locationNodeFrom: locationNodeFrom, locationNodeTo: locationNodeTo, line: self.line2)
    ...
    public func addBoxLocationNodeWithConfirmedLocation(locationNode: LocationNode) {
        ...
        self.locationBoxNode = locationNode
    }
    ...
    func updatePositionAndScaleOfLocationNodes() {
        ...
        if (self.locationNodeFrom != nil) {
            updatePositionOfLocationNodes(locationNodeFrom: self.locationNodeFrom!, locationNodeTo: self.locationNodeTo!, line: self.line)
        }
        if (self.locationNodeFrom2 != nil) {
            updatePositionOfLocationNodes(locationNodeFrom: self.locationNodeFrom2!, locationNodeTo: self.locationNodeTo2!, line: self.line2)        }
    }
    ...
    public func updatePositionOfLocationNodes(locationNodeFrom: LocationNode, locationNodeTo: LocationNode, initialSetup: Bool = false, animated: Bool = false, duration: TimeInterval = 0.1, line: SCNNode?) {
    ...
    public func updatePositionOfLocationNodesDrawBox(locationNode: LocationNode, initialSetup: Bool = false, animated: Bool = false, duration: TimeInterval = 0.1, box: SCNNode?) {
        ...
        let boxNode = createBox(locationNode: locationNode)
        if (box != nil) {
